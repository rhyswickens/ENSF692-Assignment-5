...
def book_data():
    ...
    # adding sale_price column with 25% off the prices
    book_data['Sale_prices'] = round(book_data['Prices'] * .75, 2)
...
@app.route("/learn")
def learn():
    return "I learned how to manage and manipulate data in Pandas dataframes! :)"
